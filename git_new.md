...
* *git remote add origin* - **Позволяет связать ваш проект с репозиторием**
* *git push* - **Отправляет ваш проект в репозиторий**
* *git pull* - **Позволяет из репозитория отправить обновление в проект**
